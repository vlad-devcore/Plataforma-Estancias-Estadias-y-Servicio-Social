...
const EstadiasNacionales = () => {
  ...
  const documentos = [
    ...
    {
      registro: 'Reporte mensual 1',
      formato: 'descargar',
      estado: 'pendiente'
    },
    {
      registro: 'Reporte mensual 2',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 3',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 4',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 5',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 6',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 7',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 8',
      formato: 'descargar',
      estado: 'pendiente'
    }
    ,
    {
      registro: 'Reporte mensual 9',
      formato: 'descargar',
      estado: 'pendiente'
    },
    {
      registro: 'Reporte mensual 10',
      formato: 'descargar',
      estado: 'pendiente'
    },
    {
      registro: 'Reporte mensual 11',
      formato: 'descargar',
      estado: 'pendiente'
    },
    {
      registro: 'Reporte mensual 12',
      formato: 'descargar',
      estado: 'pendiente'
    }
  ];
  ...
  return (
    <PlantillaServicio
      titulo="Estadias Nacionales"
      descripcion="Gestiona tu proceso de Estandías Nacionales, sube tus documentos y da seguimiento a tu progreso académico."
    >
      <motion.div
...
export default EstadiasNacionales;